...
#                usedInServer=True
                ...
                if usedInServer:
                        ...
                        logPath = 'H:/nrv2/log/' + address + "/" + timeDay + "/" + self.__name
                else:
...
<tr>
        <td>Test Case</td><td>&nbsp;</td><td>Log File</td>
                ...
                for item in self.__passTc:
                        if usedInServer:
                                htmlLogFullName = item[1].getLogPath().replace('/opt/log/nrv2','http://cdjcat28.cdlab.cn.ao.ericsson.se:9999/nrv2/')+ '/'+ item[1].getLogName()
                        elif useInCi:
                                htmlLogFullName = item[1].getLogPath().replace('H:/nrv2/log/','http://cdjcat28.cdlab.cn.ao.ericsson.se:9999/nrv2/log/') +  '/' + item[1].getLogName()
                        else:
