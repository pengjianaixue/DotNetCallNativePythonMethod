...
public:
    ...
    void setupUi(QDialog *RunScript)
    {
        ...
        PB_LoadCaseList->setObjectName(QString::fromUtf8("PB_LoadCaseList"));
        PB_LoadCaseList->setStyleSheet(QString::fromUtf8("selection-color: rgb(255, 0, 127);\n"
...
"}"));
    ...
    void retranslateUi(QDialog *RunScript)
    {
        ...
        checkBox->setText(QApplication::translate("RunScript", "function mode", nullptr));
        label->setText(QApplication::translate("RunScript", "Load Project Case", nullptr));
