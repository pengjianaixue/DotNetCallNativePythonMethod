...
public:
    ...
    void setupUi(QDialog *RunScript)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/RTA/PyRunner/Resources/reload.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/RTA/PyRunner/Resources/clean up.png"), QSize(), QIcon::Normal, QIcon::Off);
